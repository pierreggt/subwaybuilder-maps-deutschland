...
TARGET="$SCRIPT_DIR/../../cities/data/NUE"
VERSION="1.30.0"
echo "[Nuremberg Mod] Copying data files to cities/data/NUE..."
mkdir -p "$TARGET"
cp -f "$SCRIPT_DIR/data/NUE/"* "$TARGET/"
echo "[Nuremberg Mod] Data files copied successfully."
if [ ! -f "$SCRIPT_DIR/pmtiles" ]; then
    echo "[Nuremberg Mod] Downloading pmtiles..."
...
echo "[Nuremberg Mod] Starting tile server on port 8080..."
