...
TARGET="$SCRIPT_DIR/../../cities/data/MUC"
VERSION="1.30.0"
echo "[Munich Mod] Copying data files to cities/data/MUC..."
mkdir -p "$TARGET"
cp -f "$SCRIPT_DIR/data/MUC/"* "$TARGET/"
echo "[Munich Mod] Data files copied successfully."
if [ ! -f "$SCRIPT_DIR/pmtiles" ]; then
    echo "[Munich Mod] Downloading pmtiles..."
...
echo "[Munich Mod] Starting tile server on port 8080..."
