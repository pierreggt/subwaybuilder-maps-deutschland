(function () {
    ...
    const LOG = '[Bonn-Cologne Mod]';
    if (!api) { console.error(LOG, 'SubwayBuilderAPI not found!'); return; }

    const t = api.utils.i18n.create({
        en: {
            description: 'Fused map of Bonn and Cologne, Germany, from Cologne Bonn Airport to the surrounding Rhein-Sieg-Kreis, Rhein-Erft-Kreis and Rheinisch-Bergischer Kreis towns, covering the joined KVB and SWB Stadtbahn networks.',
            notification: 'Welcome to Bonn-Cologne!\n\nIf the map is blank, make sure run_mac-linux.sh (or run_windows.bat) is running from the mod folder. Keep the terminal window open, then restart the game.\n\nPress Ctrl + Shift + R (Cmd + Option + R on Mac) from the main menu to load mods.\n\n\n\nEnjoy!'
        },
        fr: {
            description: 'Carte fusionnee de Bonn et Cologne, Allemagne, de l aeroport de Cologne-Bonn aux villes voisines du Rhein-Sieg-Kreis, Rhein-Erft-Kreis et Rheinisch-Bergischer Kreis, sur les reseaux de Stadtbahn KVB et SWB reunis.',
            notification: 'Bienvenue a Bonn-Cologne !\n\nSi la carte est vide, verifiez que run_mac-linux.sh (ou run_windows.bat) tourne depuis le dossier du mod. Gardez le terminal ouvert, puis redemarrez le jeu.\n\nUtilisez Ctrl + Shift + R (Cmd + Option + R sur Mac) depuis le menu principal.\n\n\n\nBon jeu !'
        }
    });
    ...
    console.log(LOG, 'Bonn-Cologne mod loaded successfully!');
})();
